...
HTTP메서드 정의, 특징 등을 소개한다. 이를 토대로 서버에 요청을 위한 API를 설계할 수 있다.

해당 섹션과 다음섹션까지 이어 학습 후, 다음 MVC강의에서 테스트를 해보자.
...
![스크린샷 2024-03-27 오후 1.53.00](../img/seongtki_301.png)
